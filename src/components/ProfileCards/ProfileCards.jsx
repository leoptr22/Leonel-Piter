    ...
    <div id="inicio" className="profile-card-container">
      <div className="profile-card">
        <div className="company-logos">
          {/* Aquí puedes agregar tus logos de compañía si es necesario */}
        </div>
        <div className="profile-content">
          ...
          <div className="summary">
            <MyName />
            <h2 className='tituloResumen'>Resumen Laboral</h2>
            <p>
              Profesional con 10 años de experiencia en control de calidad en manufactura, garantizando productos de alta calidad a lo largo del proceso de producción. Actualmente, estudio programación y desarrollo web, adquiriendo competencias en JavaScript, HTML, CSS y React. Mi meta es fusionar mi experiencia en calidad con habilidades tecnológicas para mejorar la eficiencia y calidad en las empresas.
            </p>
